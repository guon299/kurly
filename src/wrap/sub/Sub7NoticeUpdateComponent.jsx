    ...
    const onSubmitInsertForm=(e)=>{
        ...
        if(state.제목===''){
            ...
            formData.append('wContent', state.내용);
                //'http://guon2999.dothome.co.kr/kurly/green_kurly_notice_table_Update_test.php'
            axios({
                url:'http://guon2999.dothome.co.kr/kurly/green_kurly_notice_table_Update.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{               
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div className="gap">   
                                                    ...
                                                    <div className="admin-name">{location.state.작성자}</div>
                                                </div>                                                
                                            </li>
                                            <li>
                                                <div className="gap">                                                    
                                                    <span className='left-label'>아이디<i>*</i></span>
                                                    <div className="admin-id">{location.state.아이디}</div>
                                                </div>                                                
                                            </li>
                                            <li>
                                                <div className="gap">                                                    
